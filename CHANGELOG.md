...
## [1.2.3]
- **Brushes**: Changed the Clay Buildup brush stamp shape from circular to a procedurally generated square to match ZBrush reference aesthetics and sculpting characteristics.
