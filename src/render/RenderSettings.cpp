...
bool RenderSettings::save(IniFile& ini, const AngleRenderer& renderer, const Scene& scene) {
    ...
    ini.setBool(sec, "fxaaSharpMode", renderer.getFxaaSharpMode());
    ini.setBool(sec, "useTaa", renderer.getUseTaa());
    ini.setBool(sec, "taaResetOnStroke", renderer.getTaaResetOnStroke());
    ini.setBool(sec, "useMotionVectors", renderer.getUseMotionVectors());
    ini.setBool(sec, "useReverseZ", renderer.getUseReverseZ());
    ini.setBool(sec, "usePolygonOffset", renderer.getUsePolygonOffset());
    ini.setInt(sec, "anisotropyLevel", renderer.getAnisotropyLevel());
    ini.setBool(sec, "useSubpixelCulling", renderer.getUseSubpixelCulling());
    ini.setFloat(sec, "subpixelCullThreshold", renderer.getSubpixelCullThreshold());
...
bool RenderSettings::load(const IniFile& ini, AngleRenderer& renderer, Scene& scene) {
    ...
    if (ini.hasKey(sec, "fxaaSharpMode")) renderer.setFxaaSharpMode(ini.getBool(sec, "fxaaSharpMode"));
    if (ini.hasKey(sec, "useTaa")) renderer.setUseTaa(ini.getBool(sec, "useTaa"));
    if (ini.hasKey(sec, "taaResetOnStroke")) renderer.setTaaResetOnStroke(ini.getBool(sec, "taaResetOnStroke"));
    if (ini.hasKey(sec, "useMotionVectors")) renderer.setUseMotionVectors(ini.getBool(sec, "useMotionVectors"));
    if (ini.hasKey(sec, "useReverseZ")) renderer.setUseReverseZ(ini.getBool(sec, "useReverseZ"));
    if (ini.hasKey(sec, "usePolygonOffset")) renderer.setUsePolygonOffset(ini.getBool(sec, "usePolygonOffset"));
    if (ini.hasKey(sec, "anisotropyLevel")) renderer.setAnisotropyLevel(ini.getInt(sec, "anisotropyLevel", 4));
    if (ini.hasKey(sec, "useSubpixelCulling")) renderer.setUseSubpixelCulling(ini.getBool(sec, "useSubpixelCulling"));
    if (ini.hasKey(sec, "subpixelCullThreshold")) renderer.setSubpixelCullThreshold(ini.getFloat(sec, "subpixelCullThreshold", 0.5f));
